...
import KutuImage from '../../assets/images/kutudaun2.png';
import Like from '../../assets/icon/like.svg';
import Share from '../../assets/icon/share.svg';
import Star from '../../assets/icon/Star.svg'; // Import Star icon

const KutuDaun = ({navigation}) => {
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.contentWrapper}>
        ...
        <View style={styles.titleWrapper}>
          <Text style={styles.title}>Kutu Daun Thrips Tomat</Text>
          <TouchableOpacity
        ...
        <Text style={styles.descriptiontitle}>
          Thrips adalah serangga kecil dengan panjang sekitar 1 mm yang sering
          menyerang tanaman tomat. Serangga ini dapat merusak tanaman dengan
          menghisap cairan dari sel-sel daun, bunga, dan buah. Akibatnya, daun
          tomat menjadi bercak-bercak perak atau kuning, bunga gugur lebih
          cepat, dan buah menjadi cacat atau terdistorsi.
        </Text>

        <Text style={styles.subTitle}>Cara Pengobatan</Text>
        <Text style={styles.descriptionsub}>
          1. Gunakan perangkap kuning lengket untuk menangkap thrips. {'\n'}
          2. Semprotkan larutan neem oil secara rutin. {'\n'}
