...
import Busuk from '../../assets/images/buahbusuk.png';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerWrapper}>
        ...
        <Image source={Busuk} style={styles.headerImage} resizeMode="cover" />
      ...
      <ScrollView contentContainerStyle={styles.contentWrapper}>
        ...
        <View style={styles.titleWrapper}>
          <Text style={styles.title}>Buah Busuk</Text>
        </View>
        ...
        <Text style={styles.descriptionsub}>
          1. Gunakan varietas tomat yang tahan terhadap penyakit jamur. {'\n'}
          2. Terapkan fungisida seperti copper oxychloride atau azoxystrobin
          untuk mengendalikan infeksi jamur. {'\n'}
          3. Perbaiki sirkulasi udara dan drainase agar kelembapan berlebih yang
          mendukung pertumbuhan jamur dapat dihindari.
        </Text>
      </ScrollView>
