  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerWrapper}>
        ...
        <Image source={Bercak} style={styles.headerImage} resizeMode="cover" />
      ...
      <ScrollView contentContainerStyle={styles.contentWrapper}>
        ...
        <Text style={styles.descriptiontitle}>
          ...
          kehitaman dengan tepian yang berwarna kuning.
        </Text>
        <Text style={styles.subTitle}>Cara Pengobatan</Text>
        <Text style={styles.descriptionsub}>
          1. Gunakan fungisida seperti copper oxychloride atau mancozeb untuk
          mengendalikan infeksi jamur. {'\n'}
          2. Potong dan buang daun yang terinfeksi untuk mencegah penyebaran
          penyakit. {'\n'}
          3. Perbaiki jarak tanam dan pastikan sirkulasi udara yang baik untuk
          mengurangi kelembapan yang mendukung pertumbuhan jamur.
        </Text>
