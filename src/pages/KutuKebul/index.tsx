...
import Kebul from '../../assets/images/kutukebul.png';
import Like from '../../assets/icon/like.svg';
import Share from '../../assets/icon/share.svg';
import Star from '../../assets/icon/Star.svg'; // Import Star icon

const KutuKebul = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerWrapper}>
        ...
        <Image source={Kebul} style={styles.headerImage} resizeMode="cover" />
      ...
      <ScrollView contentContainerStyle={styles.contentWrapper}>
        ...
        <Text style={styles.descriptiontitle}>
          Hama kutu daun bersayap putih ini merupakan salah satu hama paling
          berbahaya yang menyerang tanaman tomat dengan cara menghisap cairan
          daun, menyebabkan daun menguning, mengeriting, dan layu.
        </Text>

        <Text style={styles.subTitle}>Cara Pengobatan</Text>
        <Text style={styles.descriptionsub}>
          1. Gunakan perangkap kuning untuk menarik dan menangkap kutu daun
          bersayap putih. {'\n'}
          2. Aplikasikan minyak neem secara rutin untuk membasmi hama dan
          mencegah penyebaran. {'\n'}
          3. Semprotkan insektisida berbahan aktif yang ramah lingkungan sesuai
          anjuran.
        </Text>
